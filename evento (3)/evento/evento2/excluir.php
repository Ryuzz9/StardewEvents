...
<!-- CONTEINER 1 -->
 ...
 <center>
    <!--TITLE TOP-->
    <p class="sectionTitle" id="backToTop">Excluir</p>
    <p class="sectionDescription">Exclua a conta pelo id</p>
    <form action="excluir.php" method="post"><p>
                <h4>ID</h4></p>
                <input type="text" name="id"placeholder="digite o id para exclusão"></p>
...
if (isset($_POST['id'])) {/*retornavel como verdadeiro*/
    $id = $_POST['id'];

    // Consulta o campo 'id' na tabela 'usuario' indicada na conexão
    $exclusao = "DELETE FROM login WHERE id = $id";
    

    //se o id for true, usuario será excluido
